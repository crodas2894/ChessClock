...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {seg1[6]}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {seg2[3]}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {seg1[5]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {seg1[4]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {seg1[3]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {seg2[6]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {seg2[5]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {seg2[4]}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {seg1[2]}];  # "JB1"
set_property PACKAGE_PIN V8 [get_ports {CAT2}];  # "JB10"
set_property PACKAGE_PIN W11 [get_ports {seg1[1]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {seg1[0]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {CAT1}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {seg2[2]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {seg2[1]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {seg2[0]}];  # "JB9"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {seg3[5]}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {seg3[6]}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {seg3[3]}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {seg3[4]}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {seg4[5]}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {seg4[6]}];  # "JC3_P"
set_property PACKAGE_PIN U4  [get_ports {seg4[3]}];  # "JC4_N"
set_property PACKAGE_PIN T4  [get_ports {seg4[4]}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {seg3[1]}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {seg3[2]}];  # "JD1_P"
set_property PACKAGE_PIN V4 [get_ports {CAT3}];  # "JD2_N"
set_property PACKAGE_PIN V5 [get_ports {seg3[0]}];  # "JD2_P"
set_property PACKAGE_PIN W5 [get_ports {seg4[1]}];  # "JD3_N"
set_property PACKAGE_PIN W6 [get_ports {seg4[2]}];  # "JD3_P"
set_property PACKAGE_PIN U5 [get_ports {CAT4}];  # "JD4_N"
set_property PACKAGE_PIN U6 [get_ports {seg4[0]}];  # "JD4_P"
